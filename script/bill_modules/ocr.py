...
class ocr:
    ...
    def azure_layout(self):
        ...
        raw_output=form_pages[0].to_dict() #get raw output
        main_dfas=[]

        for table in form_pages[0].tables:
        ...
        if form_pages[0].lines!=None:
            lines=[{'text':i.text,'bounding_box':ocr_utils.dict_bb(ocr_utils.bb_convert_layout(i.bounding_box))} for i in form_pages[0].lines]
        else:
            lines=[]
        #creating dict
        final_report={}
